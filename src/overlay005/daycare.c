...
void Egg_CreateEgg(Pokemon *egg, u16 species, u8 param2, TrainerInfo *trainerInfo, int param4, int metLocation)
{
    ...
    Pokemon_InitWith(egg, species, 1, INIT_IVS_RANDOM, 0, 0, FALSE, 0, 0, OTID_NOT_SET, 0);
...
static void Egg_SetInitialData(Pokemon *mon, u16 species, Daycare *daycare, u32 monOTID, u8 form)
{
    ...
    Pokemon_InitWith(mon, species, EGG_POKEMON_LEVEL, INIT_IVS_RANDOM, 0, 0, TRUE, personality, 0, OTID_NOT_SET, 0);
...
static void Egg_CreateHatchedMonInternal(Pokemon *egg, enum HeapID heapID)
{
    ...
    Pokemon_InitWith(mon, species, 1, INIT_IVS_RANDOM, 0, 0, TRUE, personality, 0, OTID_NOT_SET, 0);
