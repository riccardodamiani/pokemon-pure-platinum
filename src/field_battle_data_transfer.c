...
FieldBattleDTO *FieldBattleDTO_NewCatchingTutorial(enum HeapID heapID, const FieldSystem *fieldSystem)
{
    ...
    Pokemon_InitWith(mon, SystemVars_GetPlayerCounterpartStarter(SaveData_GetVarsFlags(fieldSystem->saveData)), 5, INIT_IVS_RANDOM, 0, 0, FALSE, 0, OTID_NOT_SHINY, 0);
    Party_AddPokemon(dto->parties[BATTLER_PLAYER_1], mon);
    Pokemon_InitWith(mon, SPECIES_BIDOOF, 2, INIT_IVS_RANDOM, 0, 0, FALSE, 0, OTID_NOT_SHINY, 0);
